...
def mouseMoved(evt):
    ...
    label.setText("<span style='font-size: 14pt; color: white'> x = %0.2f, <span style='color: white'> y = %0.2f</span>" % (mousePoint.x(),
        mousePoint.y()))
...
proxy = pg.SignalProxy(p.scene().sigMouseMoved, rateLimit=60,
slot=mouseMoved)
